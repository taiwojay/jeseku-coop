...
export default function AboutUs() {
    return (
        <div className='page '>
          ...
          <h3>About Us</h3>
          <p> Over the years, many small and medium scale enterprises are faced with financial instability which as a result has reduced their businesses from zero to nothing.</p>
        
          <p> Therefore, to catapult low and medium income earners to the atmosphere of financial stability is why Jeseku was created. </p>
     
          <p>Jeseku is a registered digital limited liability and multi-purpose cooperative network established in 2020, borne out of the quest to expand start-up businesses and render financial assistance to entrepreneurs by creating smooth access to loan facilities.</p>
          ...
          <p> Inorder to reach out to a wide range of entrepreneurs, we devise financial expansion mechanism using the digital space to offer services such as; deposit and savings channels, advance grants, and loaning with little or no interest rates, depending on the business model.</p>
